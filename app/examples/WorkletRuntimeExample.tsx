...
import Animated, { Easing, createWorkletRuntime, runOnJS, runOnUI, useAnimatedStyle, useSharedValue, withTiming } from 'react-native-reanimated';



const WorkletRuntimeExample = () => {
  return (
    <View
      style={{
        flex: 1,
...
export default WorkletRuntimeExample